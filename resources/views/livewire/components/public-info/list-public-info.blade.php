<div class="max-w-7xl p-6 mx-auto my-4">
    {{-- Lastest  --}}
    <div class="py-3">
        <h3 class="text-3xl font-bold text-primary my-3">Infomarsi Publik Terbaru</h3>
        <hr class="my-3">
    </div>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-6">
        <div class="lg:col-span-2 rounded-lg overflow-hidden shadow-md">
            ...
            <div class="my-6 p-3 flex flex-col justify-between">
                <a class="text-lg text-justify lg:text-3xl">SOSIALISASI PELAPORAN AKADEMIK MELALUI APLIKASI NEO
                    FEEDER</a>
                <div>
    ...
    <div class="py-8">
        <div class="py-3">
            <h3 class="text-3xl font-bold text-primary ">Informasi Publik Lainnya</h3>
            <hr class="my-3">
        </div>
